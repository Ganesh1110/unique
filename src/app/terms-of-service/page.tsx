...
export default function TermsOfServicePage() {
  return (
    <PolicyPage title="Terms of Service" lastUpdated="June 2024">
      <p>These Terms of Service govern your use of the AURA website and your purchase of our products. By accessing our site or placing an order, you agree to these terms.</p>
      ...
      <p>All content on this site, including text, images, and designs, is the property of AURA and may not be reproduced without our written permission.</p>
      <h2>Limitation of Liability</h2>
      <p>To the fullest extent permitted by law, AURA shall not be liable for any indirect, incidental, or consequential damages arising from your use of the site or purchase of our products.</p>
      <h2>Contact</h2>

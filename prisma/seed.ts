...
const products: ProductSeed[] = [
  { handle: 'solitaire-pendant', title: 'The Solitaire Pendant', productType: 'Necklaces', vendor: 'AURA Atelier', price: 18500, compareAtPrice: 22500, description: 'A timeless single-stone pendant crafted in 14k gold, designed to sit beautifully at the neckline.', collection: 'diamonds', tags: ['diamond', 'necklace', 'everyday'], material: '14k Gold', totalInventory: 12 },
  { handle: 'halo-engagement-ring', title: 'Halo Engagement Ring', productType: 'Rings', vendor: 'AURA Atelier', price: 67500, description: 'Our signature halo ring with a certified center diamond, wrapped in a delicate halo of pavé stones.', collection: 'bridal', tags: ['diamond', 'ring', 'bridal'], material: '18k Yellow Gold', totalInventory: 5 },
  { handle: 'gold-tennis-bracelet', title: 'Gold Tennis Bracelet', productType: 'Bracelets', vendor: 'AURA Atelier', price: 32400, compareAtPrice: 36000, description: 'A fluid line of uniformly matched stones in 14k gold, a modern essential for everyday stacking.', collection: 'gold', tags: ['gold', 'bracelet', 'classic'], material: '14k Gold' },
  { handle: 'emerald-drop-earrings', title: 'Emerald Drop Earrings', productType: 'Earrings', vendor: 'AURA Atelier', price: 28750, description: 'Certified emeralds suspended in hand-finished gold, glimmering with every turn.', collection: 'gemstones', tags: ['emerald', 'earrings', 'statement'], material: '22k Gold' },
  { handle: 'signet-ring', title: 'Mumbai Signet Ring', productType: 'Rings', vendor: 'AURA Atelier', price: 24000, description: 'An engraved signet ring in solid gold — a modern heirloom carrying your story.', collection: 'gold', tags: ['gold', 'ring', 'engraved'], material: '18k Yellow Gold' },
  { handle: 'pearl-strand', title: 'Akoya Pearl Strand', productType: 'Necklaces', vendor: 'AURA Atelier', price: 41200, description: 'Lustrous Akoya pearls hand-knotted on silk — an heirloom piece for generations.', collection: 'new-arrivals', tags: ['pearl', 'necklace', 'bridal'], material: 'Pearl & Gold', totalInventory: 8 },
  { handle: 'stackable-bangles', title: 'Stackable Gold Bangles', productType: 'Bracelets', vendor: 'AURA Atelier', price: 29800, compareAtPrice: 33500, description: 'A set of slim gold bangles made for stacking and mixing with your own pieces.', collection: 'gold', tags: ['gold', 'bangle', 'stackable'], material: '22k Gold' },
  { handle: 'ruby-studs', title: 'Ruby Stud Earrings', productType: 'Earrings', vendor: 'AURA Atelier', price: 15900, description: 'Certified Burmese rubies in classic four-prong gold settings — understated and rich.', collection: 'gemstones', tags: ['ruby', 'earrings', 'everyday'], material: '14k Gold' },
  { handle: 'moonstone-ring', title: 'Moonstone Cocktail Ring', productType: 'Rings', vendor: 'AURA Atelier', price: 21300, description: 'A luminous moonstone crowned in pavé, made for evenings that matter.', collection: 'new-arrivals', tags: ['moonstone', 'ring', 'statement'], material: '18k White Gold' },
  { handle: 'diamond-love-band', title: 'Diamond Love Band', productType: 'Rings', vendor: 'AURA Atelier', price: 38900, description: 'A band of continuous diamonds that catches the light from every angle.', collection: 'bridal', tags: ['diamond', 'ring', 'bridal'], material: '18k White Gold' },
  { handle: 'rose-quartz-pendant', title: 'Rose Quartz Pendant', productType: 'Necklaces', vendor: 'AURA Atelier', price: 12600, description: 'A soft rose quartz heart on a delicate chain — a token of tenderness.', collection: 'new-arrivals', tags: ['rose-quartz', 'necklace', 'everyday'], material: '14k Rose Gold' },
  { handle: 'sapphire-halo-pendant', title: 'Sapphire Halo Pendant', productType: 'Necklaces', vendor: 'AURA Atelier', price: 31600, description: 'A deep blue sapphire encircled by tiny diamonds in warm gold settings.', collection: 'gemstones', tags: ['sapphire', 'necklace', 'statement'], material: '18k Yellow Gold' },
  {
